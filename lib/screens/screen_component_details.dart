...
class ScreenComponentDetails extends ConsumerStatefulWidget {
  final ComponentModel component;

  const ScreenComponentDetails({super.key, required this.component});

  @override
  ConsumerState<ScreenComponentDetails> createState() =>
      _ScreenComponentDetailsRiverpodState();
}

class _ScreenComponentDetailsRiverpodState
    extends ConsumerState<ScreenComponentDetails>
